...
public class SingleChoice extends TestBase {
    @Test(groups = {Categories.ICMS_QUESTION_CREATION, Categories.ICMS_SMOKE_TEST_CASE, Categories.ICMS_QUESTION, Categories.ICMS_SINGLECHOICE}, description = "Create Single Choice Question")
